    ...
    public class ModIoConfiguration : ThunderKitSetting
    {
        ...
        private MarkdownElement Markdown
        {
            get
            {
                ...
                {
                    Data = File.Exists("Assets/Plugins/ThunderkitModioUpload/Editor/ThunderkitModioSettingsWarning.md") ? "Assets/Plugins/ThunderkitModioUpload/Editor/ThunderkitModioSettingsWarning.md" : GetPath("Editor/ThunderkitModioSettingsWarning.md"),
        ...
        public override void CreateSettingsUI(VisualElement rootElement)
        {
            ...
            var settingsElement = 
                TemplateHelpers.LoadTemplateInstance("Assets/Plugins/ThunderkitModioUpload/Editor/ModIoSettings.UXML") ??
            ...
            apiKeyBrowseButton.clickable.clicked -= () => BrowseForGame(ref ApiKeyFilePath);
            apiKeyBrowseButton.clickable.clicked += () => BrowseForGame(ref ApiKeyFilePath);
            
            var authTokenBrowseButton = settingsElement.Q<Button>("authtoken-browse-button");
            authTokenBrowseButton.clickable.clicked -= () => BrowseForGame(ref AuthTokenFilePath);
            authTokenBrowseButton.clickable.clicked += () => BrowseForGame(ref AuthTokenFilePath);
        ...
        private void BrowseForGame(ref string value)
        {
            LocateGame(ref value);
            UpdateMarkdown();
        }

        private void LocateGame(ref string value)
        {
